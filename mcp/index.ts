...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  if (request.params.name === "read_post") {
    const { slug, lang } = request.params.arguments as { slug: string; lang: string };
  ...
  if (request.params.name === "write_post") {
    const { slug, lang, content } = request.params.arguments as { slug: string; lang: string; content: string };
